      ...
      <div className="hero">
        ...
        <div className="hero-content">
          <div
            ...
            onBlur={(event) => onHeroFieldChange('eyebrow', event.currentTarget.textContent || '')}
          >
            {hero.eyebrow}
          </div>
          <div className="title">
          ...
          <div
            ...
            contentEditable
            suppressContentEditableWarning
            onBlur={(event) => onHeroFieldChange('subtitle', event.currentTarget.textContent || '')}
          >
            {hero.subtitle}
          </div>
        </div>
            ...
            >
              <div>
                <div
                  ...
                  contentEditable
                  suppressContentEditableWarning
                  onBlur={(event) => onDayNameChange(index, event.currentTarget.textContent || '')}
                >
                  {dayData.day}
                </div>
